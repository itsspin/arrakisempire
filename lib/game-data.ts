export const STATIC_DATA = {
  ...
  ITEMS: {
    ...
    xpPotion: {
      ...
      type: "consumable",
      rarity: "uncommon",
      description: "Grants bonus experience when used.",
      dropChance: 0,
    },
    healthPotion: {
      name: "Health Potion",
      ...
      type: "consumable",
      rarity: "common",
      description: "Restores 30 health in combat.",
      effectType: "heal",
      effectValue: 30,
      dropChance: 0,
    },
    bandage: {
      ...
      type: "consumable",
      rarity: "common",
      description: "Heals 20 health outside combat only.",
      effectType: "heal",
      effectValue: 20,
      dropChance: 0,
    },
    attackPotion: {
      ...
      type: "consumable",
      rarity: "uncommon",
      description: "Increases attack by 5 for one combat.",
      effectType: "attack_boost",
      effectValue: 5,
      dropChance: 0,
    },
